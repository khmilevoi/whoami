...
export type PairingError = NeedAtLeastTwoPlayersForPairingsError | PairingValidationError;

export type MarkDmError = PlayerNotFoundError;

export type JoinGameError = JoinAllowedOnlyWhenLobbyOpenError | MaxPlayersReachedError;
...
export type StartGameIfReadyError = NotAllPlayersConfirmedWordsError | GameConfigurationMissingError;
...
export const DOMAIN_ERROR_FACTORIES = {
  ...
  ActiveGameAlreadyExistsInChatError: () => new ActiveGameAlreadyExistsInChatError(),
  ...
  OnlyGameCreatorCanConfigureError: () => new OnlyGameCreatorCanConfigureError(),
  JoinAllowedOnlyWhenLobbyOpenError: () => new JoinAllowedOnlyWhenLobbyOpenError(),
  MaxPlayersReachedError: () => new MaxPlayersReachedError({ maxPlayers: 7 }),
  LobbyAlreadyClosedError: () => new LobbyAlreadyClosedError(),
  OnlyGameCreatorCanCloseLobbyError: () => new OnlyGameCreatorCanCloseLobbyError(),
  MinPlayersRequiredToStartError: () => new MinPlayersRequiredToStartError({ minPlayers: 3 }),
  GameCanBeConfiguredOnlyAfterLobbyClosedError: () => new GameCanBeConfiguredOnlyAfterLobbyClosedError(),
  PairingModeRequiredForNormalModeError: () => new PairingModeRequiredForNormalModeError(),
  ManualPairingAvailableOnlyForNormalManualModeError: () => new ManualPairingAvailableOnlyForNormalManualModeError(),
  NotPlayersTurnToPickPairError: () => new NotPlayersTurnToPickPairError(),
  WordCannotBeEmptyError: () => new WordCannotBeEmptyError(),
  WordMustBeSubmittedBeforeConfirmationError: () => new WordMustBeSubmittedBeforeConfirmationError(),
  WordMustBeConfirmedBeforeClueSubmissionError: () => new WordMustBeConfirmedBeforeClueSubmissionError(),
  WordMustBeConfirmedBeforeFinalizationError: () => new WordMustBeConfirmedBeforeFinalizationError(),
  NotAllPlayersConfirmedWordsError: () => new NotAllPlayersConfirmedWordsError(),
  GameConfigurationMissingError: () => new GameConfigurationMissingError(),
  PendingVoteMustBeResolvedFirstError: () => new PendingVoteMustBeResolvedFirstError(),
  QuestionTextRequiredInOnlineModeError: () => new QuestionTextRequiredInOnlineModeError(),
  ...
  UnableToResolveCurrentAskerError: () => new UnableToResolveCurrentAskerError(),
  ReverseModeAskerMissingError: () => new ReverseModeAskerMissingError(),
  WordActionsNotAvailableInCurrentStageError: () => new WordActionsNotAvailableInCurrentStageError(),
  ExpectedStageMismatchError: () => new ExpectedStageMismatchError({
  ...
  NeedAtLeastTwoPlayersForPairingsError: () => new NeedAtLeastTwoPlayersForPairingsError(),
  UnknownPlayerInManualPairingError: () => new UnknownPlayerInManualPairingError(),
  PlayerCannotPairWithSelfError: () => new PlayerCannotPairWithSelfError(),
  PlayerHasAlreadySelectedAPairError: () => new PlayerHasAlreadySelectedAPairError(),
  SelectedTargetIsAlreadyTakenError: () => new SelectedTargetIsAlreadyTakenError(),
} as const;
